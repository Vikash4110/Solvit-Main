...
availabilityRouter.route("/generating-actual-slots").post(verifyJWTCounselor, generatingActualSlotsFromRecurringAvailability);
availabilityRouter.route("/get-all-generated-slots").get(verifyJWTCounselor, getAllgeneratedSlots);
availabilityRouter.route("/manage-individual-slot").post(verifyJWTCounselor, managingIndividualSlot);
