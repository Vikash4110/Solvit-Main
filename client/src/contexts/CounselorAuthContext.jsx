...
//       if (token) {
//         try {
//           const response = await axiosInstance.get(API_ENDPOINTS.COUNSELOR_PROFILE, {
...
//       const response = await axiosInstance.post(API_ENDPOINTS.COUNSELOR_APPLICATION, formData, {
//         headers: {
...
//         'counselor',
//         JSON.stringify({ ...counselor, applicationStatus: 'pending' })
//       );
//       return { success: true };
//     } catch (error) {
