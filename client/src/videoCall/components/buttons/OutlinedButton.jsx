      ...
      >
        ...
        >
          ...
          >
              ...
              {Icon &&
                (lottieOption ? (
                  ...
                  <>
                    <Icon
                      style={{
                        color: isFocused ? focusIconColor || '#1C1F2E' : color ? color : '#fff',
                        height: iconSize,
                        width: iconSize,
                      }}
                      fillcolor={isFocused ? focusIconColor || '#1C1F2E' : color ? color : '#fff'}
                    />
                    {badge && (
                      <p className={`${isFocused ? 'text-black' : 'text-white'} text-base ml-2`}>
                        {badge}
                      </p>
                    )}
                  </>
            ...
            {buttonText ? (
              <p className="text-sm text-white font-semibold mr-2 text-center">{buttonText}</p>
            ) : null}
          </button>
