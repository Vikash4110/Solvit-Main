...
export const ClinicalNotesModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        size="lg"
        className="p-0 gap-0 flex flex-col max-h-[88vh] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-2xl rounded-2xl sm:rounded-3xl overflow-hidden"
      >
        {/* Header with Client Info & Privacy Badge (pr-14 reserves space for the close X button) */}
        <div className="px-5 py-4 sm:px-6 sm:py-5 bg-gradient-to-r from-primary-50/80 via-white to-blue-50/50 dark:from-neutral-900 dark:via-neutral-900 dark:to-primary-950/30 border-b border-neutral-200 dark:border-neutral-800 shrink-0 pr-14 sm:pr-16">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3.5 min-w-0">
              <Avatar className="w-11 h-11 sm:w-12 sm:h-12 border-2 border-primary-500/20 shadow-sm shrink-0">
              ...
              <div className="min-w-0">
                <DialogTitle className="text-base sm:text-lg font-bold text-neutral-900 dark:text-white truncate">
                  {clientName}
                </DialogTitle>
        ...
        {/* Modal Body with proper scrolling and min-h-0 */}
        ...
        {/* Modal Footer (Fixed at bottom with proper padding and shrink-0) */}
        <div className="px-5 py-4 sm:px-6 sm:py-4.5 bg-neutral-50/90 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-2.5">
            {!isEditing && noteData ? (
              <>
                <Button variant="outline" size="sm" onClick={onClose} className="rounded-xl px-4 py-2 text-xs">
                  Close
                </Button>
                <Button
                  size="sm"
                  onClick={() => setIsEditing(true)}
                  className="rounded-xl bg-primary-600 hover:bg-primary-700 text-white shadow-sm px-4 py-2 text-xs"
                >
              ...
              <>
                ...
                {!noteData && (
                  <Button variant="outline" size="sm" onClick={onClose} disabled={saving} className="rounded-xl px-4 py-2 text-xs">
                    Close
                  </Button>
                )}
                <Button
