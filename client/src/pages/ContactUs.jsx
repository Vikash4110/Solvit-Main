  ...
  const faqItems = [
    {
      ...
      answer: 'Simply browse our counselors, select your preferred time slot, and complete the booking process. Payment is secure and you\'ll receive instant confirmation.'
    },
    {
      icon: FaUserMd,
      question: 'Are your counselors licensed?',
      answer: 'Yes, all our counselors are licensed professionals with verified credentials. We maintain strict quality standards for all practitioners on our platform.'
    },
    {
      icon: FaCalendarAlt,
      question: 'Can I reschedule my appointment?',
      answer: 'Yes, you can reschedule up to 24 hours before your appointment through your client dashboard or by contacting our support team.'
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            We're committed to providing you with the best mental health support experience.
          </motion.p>
        </div>
        ...
        >
          {contactInfo.map((info, index) => (
            ...
            >
              <div className={`inline-flex items-center justify-center w-16 h-16 ${info.bgColor} rounded-2xl mb-4`}>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500">We'll get back to you within 24 hours at {formData.email}</p>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    <p className="text-sm text-blue-700">
                      <span className="font-medium">Privacy Notice:</span> Your message will be sent directly to our support team via email. 
                      {prefilledFromProfile && ' Your secured profile information ensures faster response times.'}
                    </p>
                  </div>  
          ...
          >
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8">
              ...
              <p className="text-gray-600 mb-6">
                Stay connected with us on social media for mental health tips, updates, and community support.
              </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-red-700 text-sm mb-3">
                    If you're experiencing a mental health crisis, please contact emergency services or call the National Suicide Prevention Lifeline.
                  </p>
