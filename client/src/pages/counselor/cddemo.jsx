  ...
  return (
    <section className="relative h-screen pt-[80px] flex items-center overflow-hidden justify-center">
      ...
      <motion.div
        ...
        className="relative z-10 w-full h-screen flex items-center justify-end px-4 sm:px-6 lg:px-16 xl:px-24"
      >
        ...
        >
          <div className="bg-gradient-to-br from-[#f5f7fa]/98 to-white/98 dark:bg-neutral-900/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-[#c5cbd4]/30 dark:border-neutral-800/50 p-4 lg:p-6 h-[calc(100vh-100px)] flex flex-col justify-between">
            {/* Header - Fixed at top */}
            <div className="flex mb-2 justify-between">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-lg font-bold text-neutral-900 dark:text-white">Solvit</h1>
                  ...
                  return (
                    <div key={item.number} className="flex flex-col items-center flex-1 relative">
                      <motion.div
                        ...
                        className={`relative flex items-center justify-center w-9 h-9 lg:w-10 lg:h-10 rounded-full transition-all duration-300 ${
                          isCompleted
                      ...
                      {index < steps.length - 1 && (
                        <div
                          className={`absolute top-4 lg:top-5 left-1/2 w-full h-0.5 -z-10 ${
                            isCompleted
                    ...
                    {step === 1 && (
                      ...
                      >
                        <div className="text-center space-y-2 ">
                          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-950/30 dark:to-primary-900/30 mb-3 shadow-md">
                            <Mail
                        ...
                        <div className="space-y-2">
                          <Label
                            htmlFor="email"
                            className="text-neutral-900 dark:text-white font-medium text-sm"
                          >
                            Email Address *
                          </Label>
                          <div className="relative">
                            ...
                            <Input
                              ...
                              className="pl-10 h-11 bg-white dark:bg-neutral-800 border-neutral-300 dark:border-neutral-700 focus:border-primary-500 dark:focus:border-primary-500 focus:ring-primary-500"
                            />
                          </div>
                        </div>
                        ...
                        <Button
                          type="submit"
                          disabled={loading}
                          className="w-full h-11 bg-gradient-to-r from-primary-700 to-primary-600 hover:from-primary-800 hover:to-primary-700 dark:from-primary-600 dark:to-primary-500 dark:hover:from-primary-700 dark:hover:to-primary-600 text-white text-sm font-semibold shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
                        >
                          {loading ? (
                            <>
                    ...
                    {step === 2 && (
                      ...
                      >
                        ...
                        <div className="space-y-4">
                          <Label
                            htmlFor="otp"
                            className="text-neutral-900 dark:text-white text-center block font-medium text-sm"
                          >
                            Verification Code *
                          </Label>
                        ...
                        <div className="flex gap-3 pt-2">
                          <Button
                            ...
                            variant="outline"
                            onClick={() => setStep(1)}
                            className="flex-1 h-11 border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 text-sm"
                          >
                          ...
                          <Button
                            ...
                            className="flex-1 h-11 bg-gradient-to-r from-primary-700 to-primary-600 hover:from-primary-800 hover:to-primary-700 dark:from-primary-600 dark:to-primary-500 dark:hover:from-primary-700 dark:hover:to-primary-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm"
                          >
                            {loading ? (
                              <>
                                <Loader2 className="mr-2 h-4 w-4 animate-spin" aria-hidden="true" />
                    ...
                    {step === 3 && (
                      ...
                      >
                        <div className='flex p-2 justify-between'>
                          ...
                          <div className=" dark:border-neutral-800 ">
                            <div className="relative group">
                              <Avatar className="h-20 w-20 scale-220 top-6 ring-2 ring-neutral-200 dark:ring-neutral-800 transition-all duration-300 hover:scale-220 group-hover:ring-primary-400  dark:group-hover:ring-primary-600 shadow-lg">
                              ...
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                  <Button
                                    ...
                                    size="icon"
                                    variant="secondary"
                                    className="absolute bottom-0 left-8 top-14 h-7 w-7 scale-80 rounded-full shadow-lg  transition-opacity duration-300 bg-white dark:bg-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-700 border-2 border-white dark:border-neutral-900"
                                  >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="space-y-1.5">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                onChange={handleInputChange}
                                className="pl-9 h-10 bg-white dark:bg-neutral-800 border-neutral-300 dark:border-neutral-700 focus:border-primary-500 dark:focus:border-primary-500 text-sm"
                              />
                            </div>
                          </div>
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                onChange={handleInputChange}
                                className="pl-9 pr-9 h-10 bg-white dark:bg-neutral-800 border-neutral-300 dark:border-neutral-700 focus:border-primary-500 dark:focus:border-primary-500 text-sm"
                              />
                              <button
                                type="button"
                          ...
                          <div className="space-y-1.5">
                            <Label htmlFor="gender" className="font-medium text-xs">
                              Gender *
                            </Label>
                            <Select
                            ...
                            >
                              <SelectTrigger className="h-10 bg-white dark:bg-neutral-800 border-neutral-300 dark:border-neutral-700 text-sm">
                          ...
                          <div className="space-y-1.5">
                            <Label htmlFor="specialization" className="font-medium text-xs">
                              Specialization *
                            </Label>
                            <Select onValueChange={handleSpecializationSelect}>
                              <SelectTrigger className="h-10 bg-white dark:bg-neutral-800 border-neutral-300 dark:border-neutral-700 text-sm">
                                <span className='text-[#8b7355]'>Add Specialization</span>
                              </SelectTrigger>
                              <SelectContent>
                        ...
                        {formData.specialization.length > 0 && (
                          <div className="space-y-1.5">
                            ...
                            <div className="flex gap-1.5 overflow-x-scroll  overflow-y-hidden scrollbar-thin scrollbar-thumb-primary-300 dark:scrollbar-thumb-primary-700 scrollbar-track-transparent">
                              {formData.specialization.map((spec) => (
                                <Badge
                                  key={spec}
                                  variant="secondary"
                                  className="px-4 bg-primary-50 dark:bg-primary-950/30 text-primary-700 dark:text-primary-300 border border-primary-200 dark:border-primary-800 text-[10px] font-medium"
                                >
                                  {spec}
                                  <button
                                    type="button"
                        ...
                        <div className="flex gap-2.5 pt-3">
                          <Button
                            ...
                            variant="outline"
                            onClick={() => setStep(2)}
                            className="flex-1 h-10 border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 text-sm"
                          >
            ...
            <div className="flex-shrink-0 pt-2 border-t border-neutral-200 dark:border-neutral-800 mt-2">
      ...
      <Dialog open={isPhotoDialogOpen} onOpenChange={setIsPhotoDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-primary-700 dark:text-primary-400">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="mx-auto w-16 h-16 rounded-full bg-primary-50 dark:bg-primary-950/30 flex items-center justify-center">
                <ImageIcon
