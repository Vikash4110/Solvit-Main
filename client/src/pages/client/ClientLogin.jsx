...
import { Eye, EyeOff, Key, Lock, Mail } from 'lucide-react'; // Added Eye and EyeOff imports
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.8, ease: 'easeOut' }}
      >
        <img src={loginImage} alt="Client Authentication" className="w-3/4 h-auto object-contain" />
      </motion.div>
