...
import { Eye, EyeOff, Mail, Lock, User, Phone, MapPin, Camera, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          {/* Step 1: Email and OTP */}
          {step === 1 && (
            <form onSubmit={otpSent ? handleSubmitEmail(handleVerifyOtp) : handleSubmitEmail(handleSendOtp)} className="space-y-6">
              <div>
