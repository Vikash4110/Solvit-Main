      ...
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto">
            ...
            >
              <Routes>
              <Route path="" element={<ProtectedRoute><ClientDashboardHome /></ProtectedRoute>} />
              <Route path="bookings" element={<ProtectedRoute><ClientDashboardMyBookings /></ProtectedRoute>} />
              <Route path="payments" element={<ProtectedRoute><ClientDashboardPayments /></ProtectedRoute>} />
              <Route path="counselors" element={<ProtectedRoute><ClientDashboardConnectedCounselors /></ProtectedRoute>} />
              <Route path="book-session" element={<ProtectedRoute><ClientDashboardBookNewSession /></ProtectedRoute>} />
              <Route path="notifications" element={<ProtectedRoute><ClientDashboardNotifications /></ProtectedRoute>} />
              <Route path="support" element={<ProtectedRoute><ClientDashboardHelpSupport /></ProtectedRoute>} />
              <Route path="resources" element={<ProtectedRoute><ClientDashboardResources /></ProtectedRoute>} />
              <Route path="admin" element={<ProtectedRoute><ClientDashboardAdminSupport /></ProtectedRoute>} />
