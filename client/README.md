...
- 📝 **Counselor Blog Manager Stability**: Fixed infinite render loop (`Maximum update depth exceeded`) on featured blog toggles and modernized filter controls with Shadcn UI `Select` popovers.
